...
public class AngryPaging {
	...
	public String getHTML(){
		...
		if(this.nowPage > 1){
            ...
            html.append("   <a href='"+ahref+"' class='btn_prev'></a>");
        }else{
            html.append("   <a href='#' class='btn_prev'></a>");
        }
		...
		if(this.totalPage > this.nowPage){
			...
			html.append(" <a href='"+ahref+"' class='btn_next'></a>");
		}else{
		    html.append(" <a href='#' class='btn_next'></a>");
		}
	...
	public AngryPaging(int totalCount, String nowPage, int rowCount, String qstr) {
		super();
	 ...
	 * @param info
	 */
	public AngryPaging(int totalCount, String rowCount, String nowPage) {
		super();
		if(rowCount==null){
			rowCount="100";
		}
